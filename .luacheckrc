-- PeaversIconSearch luacheck config. Thin wrapper over the shared Peavers base (../wow-api).
...
-- base.globals (PeaversChangelogs, SlashCmdList); this addon has no SavedVariables.
