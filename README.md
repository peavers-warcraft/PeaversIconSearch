...
**Website:** [peavers.io](https://peavers.io) | **Addon Backup:** [vault.peavers.io](https://vault.peavers.io) | **Issues:** [GitHub](https://github.com/peavers-warcraft/PeaversIconSearch/issues)
...
2. Ensure [PeaversIconSearchData](https://www.curseforge.com/wow/addons/peaversiconsearchdata) is also installed
...
- [PeaversIconSearchData](https://www.curseforge.com/wow/addons/peaversiconsearchdata) (required) — the item name to icon database, regenerated daily from Blizzard's client data via [wago.tools](https://wago.tools) db2 exports
